...
# Taken from: https://raw.githubusercontent.com/jonbcampos/kubernetes-series/master/helm/scripts/add_secure_helm.sh
...
echo "set key values"
export SUBJECT="/C=US/ST=Texas/L=Dallas/O=Kellen Schmidt Enterprises/OU=DEVOPS/CN=kellenschmidt.com"
...
rm ca.cert.pem ca.cert.srl ca.key.pem helm.cert.pem helm.csr.pem helm.key.pem tiller.cert.pem tiller.csr.pem tiller.key.pem

echo "verify security (output should be empty)"
helm ls --tls
